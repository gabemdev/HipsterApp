...
- (UITextField *)nameTextField {
    if (!_nameTextField) {
        ...
        _nameTextField.textColor = [UIColor hipsterBlueColor];
        _nameTextField.contentVerticalAlignment = UIControlContentVerticalAlignmentCenter;
        _nameTextField.delegate = self;
        _nameTextField.returnKeyType = UIReturnKeyNext;
        _nameTextField.font = [UIFont hipsterInterfaceFontOfSize:18.0f];
    }
...
- (UITextField *)lastNameTextField {
    if (!_lastNameTextField) {
        _lastNameTextField = [[UITextField alloc] initWithFrame:CGRectMake(0.0f, 0.0f, [[self class] textFieldWith], 30.0f)];
        ...
        _lastNameTextField.textColor = [UIColor hipsterBlueColor];
        ...
        _lastNameTextField.font = [UIFont hipsterInterfaceFontOfSize:18.0f];
    }
